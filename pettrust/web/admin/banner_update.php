                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="col-md-9">
                            ...
                            <div class="form-group ">
                                <label><label for="name">網址</label></label>
                                <input class="form-control" type="text" name="url" id="url" value="<?=$QueryRow['url']?>">
                            </div>
                            <div class="form-group ">
                                <label><label for="name">圖片</label> 推薦尺寸 980 x 450</label>
                                <input class="form-control" type="file" name="file" id="file" value="">
                                <?php if( isset($QueryRow['file']) && $QueryRow['file'] != "" && file_exists(Path_Upload.$QueryRow['file']) ) echo "<a href=\"".Url_Upload.$QueryRow['file']."\" target=\"_blank\"><img src=\"".Url_Upload.$QueryRow['file']."\" width=\"81\"></a><br><input type=\"checkbox\" name=\"file_del\" value=\"Y\">刪除圖片<br />"; ?> 
                            </div>
                            <div class="form-group ">
